...
async function creatCardImage(IdCard, fieldSide){
    ...
    cardImage.setAttribute("height", "70vh");
...
async function hiddenCardDetails(){
    state.cardSprit.avatar.src = "";
    state.cardSprit.name.innerText = "";
    state.cardSprit.type.innerText = "";
}
...
async function drawSelectCard(index){
    state.cardSprit.avatar.src = cardData[index].img;
    state.cardSprit.name.innerText = cardData[index].name;
    state.cardSprit.type.innerText = "attribute : " + cardData[index].type;
}
